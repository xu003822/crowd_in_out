...
class Questionaire(Page):
    form_model = "player"
    form_fields = ["age", "gender", "major", "income", "party", "volunteer", "strategy", "strategy_repeal"]
...
page_sequence = [consent, Disagree, Instruction, Quiz, Quiz2_1, PracticeRound, Practice, Practice2, socialpressure_Instruction,
                 Revoke_Instruction, Contribute_first_page, ResultsWaitPage, ResultsPractice, Results, Results_pressure,
                 contribution_table, Results_LastRound, Questionaire, Final_Thank_you]

...
class Results(Page):
    def is_displayed(self):
        if  self.round_number == 2 or self.round_number == Constants.num_rounds:
            return False
        else:
            return True
...
class Questionaire(Page):
    form_model = "player"
    form_fields = ["age", "gender", "major", "income", "party", "volunteer"]
...
page_sequence = [consent, Disagree, Instruction, Quiz, Quiz2_1, PracticeRound, Practice, Practice2, Reminder1,
                 Reminder2, Contribute_first_page, ResultsWaitPage, ResultsPractice, Results, contribution_table,
